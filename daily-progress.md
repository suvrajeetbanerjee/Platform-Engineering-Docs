...
- daily standup
- made the following changes to the support portal figma 
  - removed icons from all sub tabs of reports tab in admin side
  ...
  - tags will be used for report generation showing which resource caused problems in a certain given time frame
...
- using vector by datadog instead of python collector for clickhouse, created manifest to test the required data from gitlab and for building the ingestion piepline
